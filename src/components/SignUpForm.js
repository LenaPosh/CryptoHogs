...
const EyeIcon = () => (
    <svg className="confirm-password-icon" xmlns="http://www.w3.org/2000/svg" width="30" height="19.5" viewBox="0 0 60 43" fill="none">
...
const EyeSlashIcon = () => (
    <svg className="confirm-password-icon" xmlns="http://www.w3.org/2000/svg" width="30" height="22" viewBox="0 0 60 61" fill="none">
...
const SignUpForm = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        if (!isEmailValid || !isPasswordValid || !doPasswordsMatch) {
            // Если есть ошибки, то останавливаем отправку формы
            return;
        }

        // Если все проверки пройдены, можно продолжить отправку данных
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="confirm-password-container">
                        <input
                            ...
                            onChange={handleInputChange}
                            style={{ color: (!validation.passwordValid || !passwordsMatch) ? "#635F5F"  : "#E33C54" }}
                        />
                        <div onClick={togglePasswordVisibility} className="password-icon-container">
                    ...
                    <div className="confirm-password-container">
                        <input
                            ...
                            onChange={handleInputChange}
                            style={{ color: (!passwordsMatch && formData.confirmPassword) ? "#E33C54" : "#635F5F" }}
                        />
                    ...
                    <div className="information-text-with-icon" style={{ color: validation.emailValid ? "#635F5F" : "#E33C54" }}>
                    ...
                    <div className="checkbox-container"
                         style={{ color: passwordsMatch ? "#635F5F" : "#E33C54" }}>
                        <input type="checkbox" id="terms" name="terms"
                               className={`custom-checkbox ${!passwordsMatch && 'invalid-checkbox'}`}
                               disabled={!passwordsMatch} />
                        <label htmlFor="terms" className="checkbox-label">
                            I agree to Crypto’s Terms of Service and Privacy Policy.*
                        </label>
                    </div>
