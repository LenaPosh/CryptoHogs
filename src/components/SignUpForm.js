...
const EyeIcon = () => (
    <svg className="confirm-password-icon" xmlns="http://www.w3.org/2000/svg" width="40" height="29.5" viewBox="0 0 60 43" fill="none">
...
const EyeSlashIcon = () => (
    <svg className="confirm-password-icon" xmlns="http://www.w3.org/2000/svg" width="40" height="41" viewBox="0 0 60 61" fill="none">
